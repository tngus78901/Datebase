...
#Register
insert into `register`(`stdNo`,`lecNo`,`proNo`) 
values('20101001', '101001','P10101');
insert into `register`(`stdNo`,`lecNo`,`proNo`) 
values('20101001', '101002','P10102');
insert into `register`(`stdNo`,`lecNo`,`proNo`) 
values('20111013', '111011','P11103');
insert into `register`(`stdNo`,`lecNo`,`proNo`) 
values('21231002', '231110','P23102');
insert into `register`(`stdNo`,`lecNo`,`proNo`) 
values('22401001', '401019','P40101');
insert into `register`(`stdNo`,`lecNo`,`proNo`) 
values('22401001', '421012','P42103');
insert into `register`(`stdNo`,`lecNo`,`proNo`) 
values('20101001', '101003','P10102');
insert into `register`(`stdNo`,`lecNo`,`proNo`) 
values('22421003', '311003','P31104');
insert into `register`(`stdNo`,`lecNo`,`proNo`) 
values('22421003', '421012','P42103');
insert into `register`(`stdNo`,`lecNo`,`proNo`) 
values('20111013', '111012','P11104');



#문제1. 모든 학생의 학생번호, 이름, 휴대폰, 학과번호, 
#학과명을 조회하시오.
SELECT 
	`stdNo`,
	`stdName`,
...
#문제4. 모든 강좌의 강좌번호, 강좌명, 담당교수 번호,
# 담당교수명, 휴대폰, 학과번호 ,학과명을 조회하시오.
SELECT * FROM 
	`lecNo`,
	`lecName`,
	b.`proNo`,
...
#문제5. 모든 수강신청 내역에서 학생번호,학생명,강좌번호,
#강좌명, 교수번호,교수명을 조회하시오.
#수강신청내역을 register table
SELECT 
a.`stdNo`,
b.`stdName`,
a.`lecNo`,
...
#문제6. 수강신청 테이블에 출석점수,중간고사 점수, 
#기말고사점수를 임의로 입력하시오.(1~100사이)
UPDATE `Register` SET 
							`regAttendScore` = CEIL(RAND() * 100);
...
UPDATE `Register` SET
								`regTotal`=
								(`regAttenScorte` + `regMidScore` +`regFinalScore`) /3;
								


#문제8. 수강신청 테이블에 총점을 기준으로 A~F등급을 입력하시오.
UPDATE `Register` SET
